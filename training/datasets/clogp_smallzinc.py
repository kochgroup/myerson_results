...
@register_dataset('clogp_smallzinc')
class clogp_smallzinc(torch_geometric.data.InMemoryDataset):
    ...
    def raw_file_names(self):
        return ['less_11_atom_clogP.csv']

    @property
    def processed_file_names(self):
        return ['clogp_smallzinc.pt']

    def download(self):
        shutil.copy("../data/less_11_atom_clogP.csv", self.raw_dir)
